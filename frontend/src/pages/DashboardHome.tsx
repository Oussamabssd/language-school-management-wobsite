...
const DashboardHome: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-2xl font-bold text-slate-800 mb-2">Welcome, {user?.first_name}!</h1>
      <p className="text-slate-500">This dashboard is currently under construction for your specific role.</p>
    </motion.div>
  );
};
