...
const ReceiptModal: React.FC<ReceiptModalProps> = ({ receipt, onClose }) => {
  ...
  const payer =
    receipt.payment_type === "student" ? payment?.student : payment?.user;
            ...
            <div className="flex justify-between items-start">
              <div className="space-y-1">
                ...
                <p className="text-sm text-slate-500">
                  123 Education Street, Casablanca, Morocco
                </p>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-700">
                    {receipt.payment_type === "student"
                      ? `Tuition Fee (${payment?.period})`
                      : `Salary Payment (${payment?.month})`}
                  </p>
                </div>
              </div>
