...
export const announcementService = {
  getAll: async (params?: any) => {
    const response = await api.get<ApiResponse<PaginatedResponse<Announcement>>>('/announcements', { params });
    return response.data;
  },

  getFeed: async (params?: any) => {
    const response = await api.get<ApiResponse<PaginatedResponse<Announcement>>>('/announcements-feed', { params });
    return response.data;
  },
